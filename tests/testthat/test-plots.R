...
test_that("gen_plots calls validate_export_config and valide_plots_config", {
  ...
  stub(gen_plots, "valide_plots_config",    mock_validate_plots)
...
test_that("gen_plots skips plot generation when spec_comparison is NULL", {
  ...
  stub(gen_plots, "valide_plots_config",         mock(NULL))
