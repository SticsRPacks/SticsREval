...
source(here::here("R/configuration.R"))
...
# ===========================================================================
# Tests: valide_plots_config
# ===========================================================================

test_that(
  "valide_plots_config passes when reference_data_dir is NULL",
  {
    cfg <- make_valid_config(list(reference_data_dir = NULL))
    expect_no_error(valide_plots_config(cfg))
  }
)

test_that(
  "valide_plots_config passes when reference_data_dir exists",
  {
    cfg <- make_valid_config(
      list(reference_data_dir = tempdir())
    )
...
test_that(
  "valide_plots_config errors when reference_data_dir is invalid",
  {
    cfg <- make_valid_config(
      list(reference_data_dir = "/nonexistent/ref")
    )
    expect_error(
      valide_plots_config(cfg),
      regexp = "Reference data directory"
    )
  }
)