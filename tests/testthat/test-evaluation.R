...
# ===========================================================================
test_that("evaluate_species calls prepare_species_workspace", {
  mock_prepare <- mock(NULL)
  stub(evaluate_species, "prepare_species_workspace", mock_prepare)
...
test_that("evaluate_species calls gen_species_stats", {
  ...
  stub(evaluate_species, "prepare_species_workspace", mock(NULL))
...
test_that(
  "evaluate calls display_comparisons_info with eval_workspace,
